...
class Metaclass_ArucoMarkers(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if ArucoMarker.__class__._TYPE_SUPPORT is None:
                ArucoMarker.__class__.__import_type_support__()
...
class ArucoMarkers(metaclass=Metaclass_ArucoMarkers):
    ...
    _fields_and_field_types = {
        'markers': 'sequence<aruco_msgs/ArucoMarker>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['aruco_msgs', 'msg'], 'ArucoMarker')),  # noqa: E501
    )
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ArucoMarker) for v in value) and
                 True), \
                "The 'markers' field must be a set or sequence and each value of type 'ArucoMarker'"
        self._markers = value

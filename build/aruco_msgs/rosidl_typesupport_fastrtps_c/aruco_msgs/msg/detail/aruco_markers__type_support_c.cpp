...
#include "aruco_msgs/msg/detail/aruco_markers__rosidl_typesupport_fastrtps_c.h"
...
#include "aruco_msgs/msg/detail/aruco_marker__functions.h"  // markers
...
using _ArucoMarkers__ros_msg_type = aruco_msgs__msg__ArucoMarkers;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: markers
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_aruco_msgs__msg__ArucoMarker(
        &array_ptr[i], cdr);
    }
  }
  ...
  aruco_msgs__msg__ArucoMarkers * ros_message)
{
  // Field name: markers
  {
    ...
    if (ros_message->markers.data) {
      aruco_msgs__msg__ArucoMarker__Sequence__fini(&ros_message->markers);
    }
    if (!aruco_msgs__msg__ArucoMarker__Sequence__init(&ros_message->markers, size)) {
      fprintf(stderr, "failed to create array for field 'markers'");
      return false;
    }
    auto array_ptr = ros_message->markers.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_aruco_msgs__msg__ArucoMarker(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aruco_msgs__msg__ArucoMarker(
  ...
  size_t current_alignment)
{
  ...
  // Field name: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aruco_msgs__msg__ArucoMarker(
  ...
  if (is_plain) {
    ...
    using DataType = aruco_msgs__msg__ArucoMarkers;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: markers
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_aruco_msgs__msg__ArucoMarker(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: markers
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_aruco_msgs__msg__ArucoMarker(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_aruco_msgs__msg__ArucoMarker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const aruco_msgs__msg__ArucoMarkers * ros_message = static_cast<const aruco_msgs__msg__ArucoMarkers *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_aruco_msgs__msg__ArucoMarkers(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  aruco_msgs__msg__ArucoMarkers * ros_message = static_cast<aruco_msgs__msg__ArucoMarkers *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_aruco_msgs__msg__ArucoMarkers(cdr, ros_message);
}

static uint32_t _ArucoMarkers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aruco_msgs__msg__ArucoMarkers(
...
static size_t _ArucoMarkers__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aruco_msgs__msg__ArucoMarkers(

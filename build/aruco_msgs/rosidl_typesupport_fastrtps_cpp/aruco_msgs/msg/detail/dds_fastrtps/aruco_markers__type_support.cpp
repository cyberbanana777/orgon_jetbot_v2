...
#include "aruco_msgs/msg/detail/aruco_markers__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aruco_msgs::msg::ArucoMarker &,
...
cdr_serialize(
  const aruco_msgs::msg::ArucoMarkers & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aruco_msgs::msg::ArucoMarkers & ros_message)
{
  // Member: markers
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aruco_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ArucoMarker(
  ...
  if (is_plain) {
    ...
    using DataType = aruco_msgs::msg::ArucoMarkers;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: markers
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      aruco_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.markers[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        aruco_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.markers[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aruco_msgs
max_serialized_size_key_ArucoMarkers(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aruco_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ArucoMarker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const aruco_msgs::msg::ArucoMarkers *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aruco_msgs::msg::ArucoMarkers *>(
    untyped_ros_message);
...
{
  return &aruco_msgs::msg::typesupport_fastrtps_cpp::_ArucoMarkers__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aruco_msgs, msg, ArucoMarkers)() {
  return &aruco_msgs::msg::typesupport_fastrtps_cpp::_ArucoMarkers__handle;
}
